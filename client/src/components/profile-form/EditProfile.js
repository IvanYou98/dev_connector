...
const EditProfile = ({profile: {myProfile, loading}, saveProfile, getCurrentProfile}) => {
    ...
    useEffect(() => {
        ...
        setFormData({
            ...
            githubUsername: loading || !myProfile.githubUsername ? '' : myProfile.githubUsername,
            bio: loading || !myProfile.bio ? '' : myProfile.bio,
            twitter: loading || myProfile.twitter ? '' : myProfile.twitter,
            facebook: loading || myProfile.facebook ? '' : myProfile.facebook,
            linkedin: loading || myProfile.linkedin ? '' : myProfile.linkedin,
            youtube: loading || myProfile.youtube ? '' : myProfile.youtube,
            instagram: loading || myProfile.instagram ? '' : myProfile.instagram
        })
    }, [])
...
export default connect(mapStateToProps, {saveProfile, getCurrentProfile})(EditProfile);